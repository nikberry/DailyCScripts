...
const int N = 5;
TString Variable;
TString Variables[N] = {"muon_AbsEta_", "muon_eta_",  "muon_pT_", "muon_phi_", "muon_dB_"};
double MinXs[N] = {0, -2.6 , 0, -3.2, 0};
double MaxXs[N] = {2.6,2.6 , 400,3.2 , 0.3};
TString XTitles[N] = {"#left|#eta#right|_{#mu}", "#eta_{#mu}", "p_{T}(#mu) [GeV]", "#phi_{#mu}", "dB_{#mu}"};
