...
const int N = 7;
TString Variable;
TString Variables[N] = {"HT", "HT_lepton", "HT_lepton_MET", "MET_1st_jet_pt", "leptonic_W_pt", "M3", "invariant_mass_lepton_1bjet"};
double MinXs[N] = {0, 0, 0, 0,0,0,0};
double MaxXs[N] = {500, 3.4, 2.6,500,500,500,500};
...
TH1D* getSample(TString sample, double weight){
	...
	TH1D* plot = (TH1D*) file->Get("DiffVariablesAnalyser/MuPlusJets/"+Variable);
